...
$query="SELECT * FROM `inventory_core` WHERE `item_name` = '$item_name' ORDER BY `inventory_core`.`Quantity` ASC ";

//Title
$pdf->SetFont('Arial','B',12);
$pdf->Cell(190,7,"Inventory Report By Item",'LTRB',1,'C');
...
$tym = date('d-m-Y');
$pdf->Output("$tym Inventory Report By Item.pdf ", 'I');
?>