...
$voucherNo=$_GET['voucherNo'];
   ...
   function Header(){
	...
	$voucherNo=$_GET['voucherNo'];
    $query="SELECT * FROM `debit_transaction` WHERE `voucher`='$voucherNo'";
	...
	$this->Cell(190,5,"Debit Voucher",1,1,'C');
...
$query="SELECT * FROM `debit_transaction` WHERE `voucher`='$voucherNo'";
	...
	$pdf->Cell(95,5,"Pay To :  $payTo",1,0,'L');$pdf->Cell(95,5,"Mobile : $mobile ",1,1,'L');
