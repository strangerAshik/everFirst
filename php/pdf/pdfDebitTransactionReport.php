...
$pdf->SetX($x);
$pdf->Cell(250,5,"Report : Debit transaction Between [ $date1 to $date2 ]",0,1,'L');
...
$pdf->ln(2);
$pdf->Cell(28,5,"Date",'LTRB',0,'C');$pdf->Cell(28,5,"$date",'LTRB',1,'C');
$pdf->Cell(40,5,"Purpose",'LTRB',0,'C');$pdf->Cell(28,5,"Voucher",'LTRB',0,'C');$pdf->Cell(28,5,"Invoice",'LTRB',0,'C');
$pdf->Cell(28,5,"Work Order",'LTRB',0,'C');$pdf->Cell(28,5,"Amount",'LTRB',0,'C');$pdf->Cell(28,5,"Paid Amount",'LTRB',0,'C');
$pdf->Cell(28,5,"Pay To ",'LTRB',1,'C');

$pdf->Cell(40,5,"$purpose",'LTRB',0,'C');$pdf->Cell(28,5,"$voucher",'LTRB',0,'C');$pdf->Cell(28,5,"$invoice_no",'LTRB',0,'C');
$pdf->Cell(28,5,"$work_order",'LTRB',0,'C');$pdf->Cell(28,5,"$amount",'LTRB',0,'C');$pdf->Cell(28,5,"$paid_amount",'LTRB',0,'C');
$pdf->Cell(28,5,"$pay_to ",'LTRB',1,'C');
...
$tym = date('d-m-Y');
$pdf->Output("$tym Debit Transaction ( $date1 to $date2 ).pdf ", 'I');
?>