...
$query="SELECT * FROM `inventory_core` WHERE `part_no` = '$part_no' ORDER BY `inventory_core`.`Quantity` ASC ";

//Title
$pdf->SetFont('Arial','B',12);
$pdf->Cell(190,7,"Inventory Report By Part No",'LTRB',1,'C');
...
$tym = date('d-m-Y');
$pdf->Output("$tym Inventory Report By Part No.pdf ", 'I');
?>