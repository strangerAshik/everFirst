		...
		<div class="wrapper fix">
			...
			<section class="section"   >
					<select id="optionContainer">
						...
						<option onclick="showHide('datePicker','customerSelect');" >Salary Report</option>
...
<!-- #################################################################################################################################### -->
		...
		<table>
	<tr>
			<td><input type='text' id='debitVoucherNo' placeholder='Debit Voucher' /></td><td><input type='button' value='Submit' onclick="reportDebitVoucherNo()"/></td>
			
	</tr>
	<tr>
			<td><input type='text' id='creditVoucherNo' placeholder='Credit Voucher'/></td><td><input type='button' value='Submit' onclick="reportCreditVoucherNo()"/></td>
