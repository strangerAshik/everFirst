...
<!--Start Source Description-->
	...
	<th>Loan Transaction Id</th><td><input id='loanTransactionId' style='width:168px;' type="text"/></td>
		...
		<tr>
			<th>Bank Name(From)</th><th>Account No(From)</th>
		</tr>		
		<tr>
			<td>
		...
		<tr>
			<th>Bank Name(To)</th><th>Account No(To)</th>
		</tr>		
		<tr>
			<td>
			
			<select id='toBankName' onchange='getThisBankAccounts2nd();'>
				<option>--Select Bank--</option>
				<?php 
					getBankList();
				?>
	...
	<table>
		<tr>
			...
			<td class="noBorder"><input type="button" onclick="keepRecordBankLoanBank();creditVoucher();" value="Generate Voucher"></td> 
		</tr>
	</table>
	</div>
	<div id='massageLoanBank'>
	</div>
	<!--End  amount-->
</div>