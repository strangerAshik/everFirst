<div class="companyLogo fix">
	<p><span><img src="../images/service.png"/></span><span>EVERFIRST TECHNOLOGY LDT.</span></p>
</div>
...
<div id="changePassword" class="white_content">
	...
	<nav class="nav  ">
			<ul>
				<li><a id="home" href="storeManagerHomepage.php">Home</a></li>
				<li><a id="inventory" href="inventory.php">Inventory</a></li>
				<li><a id="Invoice" href="invoice.php">Invoice</a></li>
				<li><a id="Challan" href="challan.php">Challan</a></li>
				<li><a id="Challan" href="reconsideration.php"> Reconsideration  </a></li>
